...
exports.SearchStyled = undefined;
...
var Search = function (_Component) {
  ...
  _createClass(Search, [{
    ...
    value: function handleChange(event) {
      ...
      this.setState({ term: event.target.value, pristine: event.target.value === '' }, function () {
        _this2.props.getTerm(_this2.state.term);
      });
    }
  }, {
    key: 'handleCancel',
    value: function handleCancel() {
      ...
      this.setState({ term: '', pristine: true }, function () {
        _this3.props.getTerm(_this3.state.term);
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: this.props.className + ' search-bar ' + (this.state.pristine ? 'pristine' : '') },
...
var SearchStyled = exports.SearchStyled = (0, _styledComponents2.default)(Search)(_templateObject);

Search.propTypes = {
  getTerm: _propTypes2.default.func.isRequired,
  className: _propTypes2.default.string.isRequired
};

exports.default = SearchStyled;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_stylis__ = __webpack_require__(41);
